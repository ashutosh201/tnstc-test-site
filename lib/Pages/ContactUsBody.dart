    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth > 800) {
          return DesktopContactUsPageBody1();
        } else {
          return MobileContactUsPageBody1();
        }
      },
    );
  }
...
class DesktopContactUsPageBody1 extends StatefulWidget {
  @override
  _DesktopContactUsPageBody1State createState() =>
      _DesktopContactUsPageBody1State();
}

class _DesktopContactUsPageBody1State extends State<DesktopContactUsPageBody1> {
...
class MobileContactUsPageBody1 extends StatefulWidget {
  @override
  _MobileContactUsPageBody1State createState() =>
      _MobileContactUsPageBody1State();
}

class _MobileContactUsPageBody1State extends State<MobileContactUsPageBody1> {
  @override
  Widget build(BuildContext context) {
    return Container();
  }
